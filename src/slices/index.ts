...
const { setInitSnippetFetched, setCurrentCommunity, setMyCommunitySnippets, setRecentCommunities, resetMySnippets, changeCommunityImages } = CommunitySlice.actions;
