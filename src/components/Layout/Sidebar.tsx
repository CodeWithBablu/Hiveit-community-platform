...
const Sidebar = ({ isDrawer, handleClose }: Props) => {
  ...
  return (
    <div className={`${isDrawer ? 'flex w-full' : 'hidden xl:flex w-[276px]'} mt-14 hover:overflow-y-scroll sticky top-14 text-sm flex-col gap-2 p-3 h-full max-h-[calc(100dvh-7rem)] overflow-y-hidden transition-all duration-300 ease-in shrink-0 rounded-xl`}>
